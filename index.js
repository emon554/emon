...
//
const BotName = 'EMON 🦏'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/fr_why14'; // Nama Instagramlu cok
const whatsapplu = '083180307056'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'Nothing'; // OFFICIAL GRUP LU 1
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @fr_why14`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @fr_why14`)
})
